...
def check_perceptron_single_update():
    ...
    feature_vector = np.array([-0.07423015, -0.39649636, 0.1351373, 0.45750093, -0.4069453, -0.18314678,
                               0.16850709, -0.16163536, -0.42638188, 0.47827094])
    label, theta, theta_0 = -1, np.array([-0.48111592, 0.00880019, -0.39314807, 0.18161511, 0.46284717, 0.18997096,
                                         0.4171585, 0.19134845, 0.43137943, 0.30600631]), -0.10761240246238635
    exp_res = (np.array([-0.4811159, 0.0088002, -0.3931481, 0.1816151, 0.4628472, 0.1899710, 0.4171585, 0.1913484,
                         0.4313794, 0.3060063]), -0.1076124)
    if check_tuple(
